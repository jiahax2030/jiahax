...
// 判断是否是手机号
export const isPhone = (value: string) => REGEX_phone.test(value);

// 判断是否是身份证号
export const isIDCard = (value: string) => REGEX_IDCard.test(value);

// 判断是否是邮箱
export const isEmail = (value: string) => REGEX_email.test(value);

// 判断是否是金额
export const isMoney = (value: string | number) => REGEX_money.test(value.toString());

// 判断是否是年龄
export const isAge = (value: string | number) => REGEX_age.test(value.toString());

// 判断是否是2-6位中文字符，姓名
export const isChinese = (value: string) => REGEX_chinese.test(value);

// 判断是否是用户名
export const isUserName1 = (value: string) => REGEX_userName1.test(value);
export const isUserName2 = (value: string) => REGEX_userName2.test(value);
export const isUserName3 = (value: string) => REGEX_userName3.test(value);
export const isUserName4 = (value: string) => REGEX_userName4.test(value);

// 判断是否是密码
export const isPwd1 = (value: string) => REGEX_pwd1.test(value);
export const isPwd2 = (value: string) => REGEX_pwd2.test(value);
export const isPwd3 = (value: string) => REGEX_pwd3.test(value);
export const isPwd4 = (value: string) => REGEX_pwd4.test(value);
export const isPwd5 = (value: string) => REGEX_pwd5.test(value);
