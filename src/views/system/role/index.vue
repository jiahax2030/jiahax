<template>
  <div class="bs-page-body">
      ...
      >
        ...
        <el-table-column fixed="right" label="操作" width="220">
          <template #default="scope">
            ...
            <el-dropdown>
              <el-button size="small" :disabled="!isEditable(scope.row)">
                更多 <i class="i-ep-arrow-down el-icon--right" />
              </el-button>
              <template #dropdown>
                <el-dropdown-menu v-hasPerm="['role-setting']">
                  <el-dropdown-item @click.native="onClickAuthRole(scope.row)"
                    ><i class="i-ep-setting" />权限配置</el-dropdown-item
                  >
                </el-dropdown-menu>
              </template>
            </el-dropdown>
    ...
    <!-- 权限设置 -->
    <AuthDialog
      v-model:is-show="isShowDialogAuthRole"
