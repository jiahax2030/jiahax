      ...
      <div class="bs-dialog input-width">
        ...
        >
          ...
          <el-form-item label="用户名:" prop="loginName">
            <el-input
              v-model="dialogFormData.loginName"
          ...
          <el-form-item label="员工编号:" prop="userNumber">
            <el-input
              v-model.number="dialogFormData.userNumber"
              :disabled="dialogType !== 'add'"
              placeholder="请输入员工编号"
              clearable
            />
          ...
          <el-form-item label="用户有效期至:" prop="userExpiryDate">
            <el-date-picker
              v-model="dialogFormData.userExpiryDate"
              type="date"
              placeholder="选择日期"
          ...
          <el-form-item v-if="dialogType !== 'add'" label="登录时间:" prop="loginDate">
            <el-date-picker
              v-model="dialogFormData.loginDate"
              disabled
              type="datetime"
              placeholder="选择日期"
          ...
          <el-form-item v-if="dialogType !== 'add'" label="创建时间:" prop="createDate">
            <el-date-picker
              v-model="dialogFormData.createDate"
              disabled
              type="datetime"
              placeholder="选择日期"
              value-format="YYYY-MM-DD HH:mm:ss"
          ...
          <el-form-item v-if="dialogType !== 'add'" label="更新时间:" prop="updateDate">
            <el-date-picker
              v-model="dialogFormData.updateDate"
              disabled
              type="datetime"
              placeholder="选择日期"
              value-format="YYYY-MM-DD HH:mm:ss"
...
watch(
  ...
  (val) => {
    state.dialogTitle =
      props.title || (val === 'add' ? '新增' : val === 'edit' ? '编辑' : val === 'look' ? '查看' : state.dialogTitle);
