    ...
    <div class="bs-page-body">
      ...
      <div class="bs-page-table">
        <div class="bs-table-btns">
          ...
          <el-button v-hasPerm="['user-export']" type="warning" icon="i-ep-download" @click="onClickExport">
            导出
          </el-button>
          <el-button
        ...
        >
          ...
          <el-table-column label="级别" min-width="100">
            <template #default="scope">
              ...
              <div
                :class="
                  scope.row.level == '1' ? 'b-tag-success' : scope.row.level == '2' ? 'b-tag-warning' : 'b-tag-error'
                "
              >
                {{ getDictLabel(scope.row.level, levelOptions) }}
              </div>
            </template>
          </el-table-column>
